# .\Setup\Windows\WindowsSetup-Config.ps1 -Force
.\Setup\Windows\check.ps1
exit 0
...
# 処理の実行
# ============================================
.\Setup\Windows\WindowsSetup-WinGet.ps1 -Run
.\Setup\Windows\WindowsSetup-PSResource.ps1
.\Setup\Windows\WindowsSetup-Command.ps1
.\Setup\Windows\WindowsSetup-msvc.ps1
